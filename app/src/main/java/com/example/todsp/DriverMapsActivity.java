...
public class DriverMapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        SettingsDriverButton.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent = new Intent(DriverMapsActivity.this, DriverHomeActivity.class);
    ...
    {
        Intent startPageIntent = new Intent(DriverMapsActivity.this, DriverHomeActivity.class);
    ...
    private void getAssignedCustomerInformation()
    {
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference()
                .child("User").child("Passenger").child(customerID);
