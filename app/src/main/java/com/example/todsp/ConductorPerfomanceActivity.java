...
public class ConductorPerfomanceActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_conductor_perfomance);

        ListView myListView = (ListView) findViewById(R.id.issuesListViewCon);
        ...
        final SimpleAdapter simpleAdapter = new SimpleAdapter(
                this ,
                issuesList ,
                R.layout.activity_conductor_perfomance ,
                new String[]{"date_con" , "start_date_dri" , "end_date_dri" , "qr_val_dri"} ,
                new int[]{R.id.date_con , R.id.start_date_con , R.id.end_date_con , R.id.qr_val_con}
        );
        ...
        dbRef = FirebaseDatabase.getInstance().getReference("attendance").child("conductor").child(Prevalent.currentOnlineUser.getPhone());
