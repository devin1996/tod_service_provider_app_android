...
public class ScanConductorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scan_conductor);

        tv_qr_readTxt = (TextView) findViewById(R.id.con_qr_read);
        ...
        scanQrBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                IntentIntegrator integrator = new IntentIntegrator(ScanConductorActivity.this);
...
//        String userPhone = Prevelent.currentOnlineUser.getPhone();
        ...
        reportListRef = FirebaseDatabase.getInstance().getReference().child("attendance").child("conductor");
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    if (task.isSuccessful()) {
                                        Toast.makeText(ScanConductorActivity.this , "Your Attendance marked" , Toast.LENGTH_SHORT).show();
                                        //loadingBar.dismiss();
                                        ...
                                        //loadingBar.dismiss();
                                        Toast.makeText(ScanConductorActivity.this , "Network Error.. please try again after some time..." , Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                } else {
                    Toast.makeText(ScanConductorActivity.this , "Your attendance already exists" , Toast.LENGTH_SHORT).show();
                    //loadingBar.dismiss();
                    Toast.makeText(ScanConductorActivity.this , "Please try again using another way" , Toast.LENGTH_SHORT).show();
    ...
    private void endDay() {
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child("attendance").child("conductor");
        ...
        startActivity(new Intent(ScanConductorActivity.this , ConductorHomeActivity.class));
        Toast.makeText(ScanConductorActivity.this , "Attendance marked successfully" , Toast.LENGTH_SHORT).show();
        finish();
    }
}